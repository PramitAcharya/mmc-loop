...
import { Route as VerifyChatRouteImport } from './routes/verify.chat'
...
const VerifyChatRoute = VerifyChatRouteImport.update({
  id: '/chat',
  path: '/chat',
...
export interface FileRoutesByFullPath {
  ...
  '/verify/chat': typeof VerifyChatRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/verify/chat': {
      id: '/verify/chat'
      path: '/chat'
      fullPath: '/verify/chat'
      preLoaderRoute: typeof VerifyChatRouteImport
...
interface VerifyRouteChildren {
  VerifyChatRoute: typeof VerifyChatRoute
}

const VerifyRouteChildren: VerifyRouteChildren = {
  VerifyChatRoute: VerifyChatRoute,
}
